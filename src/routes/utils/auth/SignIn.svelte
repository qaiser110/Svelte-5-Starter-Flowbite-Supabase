<script lang="ts">
	import { Label, Input, Hr, Checkbox, A, Button, Card } from 'flowbite-svelte';
	import { enhance } from '$app/forms';

	import { PUBLIC_WEBAPP_NAME } from '$env/static/public';

	export let title = 'Sign in to platform';
	export let site = {
		name: PUBLIC_WEBAPP_NAME,
		img: '/images/icon-logo.svg',
		link: '/',
		imgAlt: `${PUBLIC_WEBAPP_NAME} Logo`,
	};
	...
	export let registerLink = 'sign-up';
