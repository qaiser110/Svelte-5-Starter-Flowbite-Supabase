...
<Popover class="max-w-sm border-0" trigger="click" defaultClass="p-0" arrow={false} offset={10}>
	...
	<div class="bg-50 dark:bg-gray-700">
		<Notification href="/" src={Users[0].avatar} when="a few moments ago" color="purple">
			<DownloadSolid slot="icon" />
			New message from <span class="font-semibold text-gray-900 dark:text-white">Bonnie Green</span>
			: "Hey, what's up? All set for the presentation?"
		</Notification>
		<Notification href="/" src={Users[1].avatar} when="10 minutes ago" color="dark">
		...
		<Notification href="/" src={Users[3].avatar} when="44 minutes ago" color="red">
			<HeartSolid slot="icon" />
		...
		<Notification href="/" src={Users[4].avatar} when="1 hour ago" color="green">
			<AnnotationSolid slot="icon" />
		...
		<Notification href="/" src={Users[5].avatar} when="3 hours ago" color="purple">
			<CameraPhotoOutline slot="icon" />
